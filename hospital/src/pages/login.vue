      ...
      <div class="login_main">
        ...
        <div class="main_right">
          ...
          <form action="">
            ...
            <center><p style="margin-top:20px;font-size:12px;color:#FA6F03;">登录遇到问题，请联系服务台</p></center>
          </form>
        </div>
      </div>
...
<style scoped>
  ...
  .login>.login_main>.main_left{
    ...
    background: url("../assets/images/login/hosptial.jpeg") no-repeat;
  }
  ...
  .login>.login_main>.main_right>.right_title{
    ...
    text-align: center;
    line-height: 60px;
    background: url("../assets/images/login/border_img.png") repeat;
    margin-bottom: 25px;
  }
